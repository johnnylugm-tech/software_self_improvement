...
DEFAULT_CONFIG = {
    ...
    "dimensions": {
        "linting": {"enabled": True, "weight": 0.08, "target": 95, "tools": []},
        "type_safety": {"enabled": True, "weight": 0.12, "target": 95, "tools": []},
        "test_coverage": {"enabled": True, "weight": 0.15, "target": 80, "tools": []},
        "security": {"enabled": True, "weight": 0.12, "target": 90, "tools": []},
        "performance": {"enabled": True, "weight": 0.10, "target": 80, "tools": []},
        "architecture": {"enabled": True, "weight": 0.10, "target": 80, "tools": []},
        "readability": {"enabled": True, "weight": 0.09, "target": 85, "tools": []},
        "error_handling": {"enabled": True, "weight": 0.11, "target": 85, "tools": []},
        "documentation": {"enabled": True, "weight": 0.12, "target": 85, "tools": []},
        "secrets_scanning": {"enabled": True, "weight": 0.09, "target": 100, "tools": []},
        "mutation_testing": {"enabled": False, "weight": 0.10, "target": 70, "tools": []},
        "property_testing": {"enabled": False, "weight": 0.07, "target": 75, "tools": []},
        "fuzzing": {"enabled": False, "weight": 0.08, "target": 70, "tools": []},
        "license_compliance": {"enabled": False, "weight": 0.05, "target": 95, "tools": []},
